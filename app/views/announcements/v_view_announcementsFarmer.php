...
<div id="mainContent" class="announcement-view">
    <div class="announcement-detail-card">
        <a href="<?php echo URLROOT; ?>/Announcements/AnnouncementsFarmer#announcement-<?php echo $data['announcement']->announcement_id; ?>" class="clear-results">❌</a>
        ...
        <div class="back-link">
            <a href="<?php echo URLROOT; ?>/Announcements/AnnouncementsFarmer#announcement-<?php echo $data['announcement']->announcement_id; ?>">⬅ Back to Announcements</a>
        </div>
    </div>
</div>
