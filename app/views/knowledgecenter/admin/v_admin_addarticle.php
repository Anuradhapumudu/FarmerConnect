...
<main class="main-content" id="mainContent">
    <h1>Add Knowledge Article to <?php echo $data['category_name']; ?></h1>
    <form method="POST" action="<?php echo URLROOT; ?>/Knowledgecenter/addarticle" enctype="multipart/form-data">
