...
<div class="content-card">
    <div class="success-container">
        ...
        <p class="success-message">Your disease report has been submitted and will be reviewed by our agricultural
            experts.</p>
        ...
        <div class="success-actions">
            <a href="<?php echo URLROOT; ?>/disease/viewReport/<?php echo htmlspecialchars($data['report_id']); ?>"
