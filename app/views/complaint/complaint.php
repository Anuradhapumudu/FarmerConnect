...
<div class="content-card">
    <div class="content-header">
        <div>
            <h1 class="content-title">Complain Center</h1>
            <p class="content-subtitle">
                <?php echo isset($data['isEdit']) && $data['isEdit'] ? 'Update your complain report' : 'Report complaints to help improve our services'; ?>
            </p>
        </div>
    ...
    <?php if (isset($data['isEdit']) && $data['isEdit']): ?>
        <div class="report-id-display">
            ...
            <span><?php echo htmlspecialchars($data['complaint_id']); ?></span>
        </div>
    <?php endif; ?>
    ...
    <form action="<?php echo URLROOT; ?>/complaint/<?php echo isset($data['isEdit']) && $data['isEdit'] ? 'updateReport' : 'submit'; ?>" method="POST" id="complaintReportForm" class="framework-form" enctype="multipart/form-data">
        ...
        <div class="form-group-split">
            <div class="form-group-half">
                <label for="observationDate" class="required-label">Observation Date <span class="required-star">*</span></label>
            ...
            <div class="form-group-half">
                <label for="todayDate" class="required-label">Today's Date</label>
        ...
        <div class="form-group">
            <label for="description" class="required">Complaint Description</label>
